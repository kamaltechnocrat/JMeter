...
public class PO_Assigns_Registrant_As_Amender {
	...
	public void requestAmendments() throws Exception {
		...
		String[] amendParams = AmendmentsUtil.initializeAmendmentParamsNoOptionalRex(foProj, "/qa_Registrant4/", IGeneralConst.gnrl_SubmissionA[0][0]);
	...
	public void testAmendedSubmissionsAccessableByRegistrant_1() throws Exception {
		...
		Assert.assertTrue(GeneralUtil.isTextFieldReadOnly(0),"FAIL: the eForm should in ReadOnly mode");
	...
	public void reSubmitAmendedSubmissions() throws Exception {
		...
		Assert.assertTrue(foProj.submitAmendedFOProject(IGeneralConst.gnrl_SubmissionA[0][0], true));		
	}
