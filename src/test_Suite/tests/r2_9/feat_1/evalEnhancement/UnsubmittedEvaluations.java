...
public class UnsubmittedEvaluations {
	...
	public void setUp() {
		try {
			...
			proj = new Project(fopp,"NotUsed-Evals-", true,true,EFormsUtil.createAnyRandomString(5));
	...
	public void setApprovalStep() throws Exception {
		try {
			...
			Assert.assertTrue(proj.approveSubmission(IGeneralConst.approvQuoCritAuto[0][0], false, IFiltersConst.evaluateSubmissions_Ready_StatusSubView,false, false));
	...
	public void testNotUsedInProgressApproval() throws Exception {
		try {
			...
			Assert.assertTrue(ProjectUtil.openEvaluateSubmissionFormletInList(proj,IGeneralConst.approvQuoCritAuto[0][0], IFiltersConst.evaluateSubmissions_NotUsed_StatusSubView, "Approval", true));
