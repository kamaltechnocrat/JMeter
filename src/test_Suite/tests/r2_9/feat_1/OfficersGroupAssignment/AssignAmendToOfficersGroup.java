...
public class AssignAmendToOfficersGroup {
	...
	public void testAmendmentAvailableToOther() throws Exception {
	...
	@Test(groups = {"WorkflowNG"},dependsOnMethods="testAmendmentAvailableToOther")
	public void testChangingAmender() throws Exception {
		
		Assert.assertTrue(AmendmentsUtil.changeAmender(proj,IPreTestConst.Groups[10][1][3]));
		
	}
	
	@Test(groups = {"WorkflowNG"},dependsOnMethods="testChangingAmender")
	public void testReadOnlyAmendmentSubmission() throws Exception {
