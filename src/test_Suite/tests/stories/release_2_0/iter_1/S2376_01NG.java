...
/*
 * Test Case 01 for User Story # 2376 - Limit the activation of PO user (User List page)
 * 
 * Tests:
 ...
 * 5. open user list filter to Inactive
...
public class S2376_01NG {

	// #####***********************************************************************
	// ### To set up the Global Params Name Vars
	// #####***********************************************************************
	Class<? extends S2376_01NG> ownClass = this.getClass();

	private Log log = LogFactory.getLog(ownClass);

	int UserIndex = 6; // Documnets Manager
	Users user;
	int usersCount;
	...
	public void testActivationCheckBoxAvailabilityNG() throws Exception {
		try {
			...
			Assert.assertFalse(UsersAndGroupsUtil.doesActivationCheckBoxEnabledInList(user.getUsrName() + "1"), "FAIL: The Checkbox should be disabled in List!");
