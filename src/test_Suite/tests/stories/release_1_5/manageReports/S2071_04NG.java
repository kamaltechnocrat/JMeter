 ...
 * 4. for this Case Testing (Dropdown from a Lookup)
 * 5. click Save.
 * 6. Add Parameters ( CountryId)
...
public class S2071_04NG {
	...
	public void initializeAndCreateReportNG() throws Exception {
		...
		report.setReportIdent(report.getReportLetter() + IReportsConst.reportId	+ "-S1971_04NG");
