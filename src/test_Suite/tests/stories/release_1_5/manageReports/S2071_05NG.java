/* Test Case _05 For Story #2071  Reports Planner: report parameters details (Programs related)
 * Steps:
 * 1. Log in As a Super User
 * 2. Add new Reports (plus sign)
 * 3. in the Report detail enter values 
 * 4. for this Case Testing (Projects)
 * 5. click Save.
...
public class S2071_05NG {
	...
	Reports report;
	FOProject foProj;
	int reportIndex = 4; //ApplicationSuccessful_Letter.rpt
	...
	public void initializeAndCreateReportNG() throws Exception {
		...
		report.setReportIdent(report.getReportLetter() + IReportsConst.reportId	+ "-S1971_05NG");
