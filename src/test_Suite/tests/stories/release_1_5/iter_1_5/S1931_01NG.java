/*
 * Test Case _01 For Story #1931  Step Notification - Step entry from a paused step
 * Steps:
 *  1. Create Program as Follow
 *  1.1. Submission
 *  
 *  1.2. Approval - Step Entry from a Paused step, Notify Approvers and PO Groups 1 Day before step start, Repeat Every day
 *  
 *  1.3. Award
 *    
 *  
...
public class S1931_01NG {
	...
	public void testStepEntryFromAPausedStepNotificationOneDayBeforeNG() throws Exception {
		try {
	...
	private void createFundingOpp() throws Exception {
		...
		if (newProgram) {
			...
			prog.manageStepNotification(
					...
					repeatNotifyPO, new String[] { approversGrp[0] }, "1", "1");
