 ...
 * @author s.grobbelaar
 * 
 * Tests Required On Demand functionality when is set to Program Office Only
...
public class ODSS_PAReq_POOnly {
	...
	private String postIdfr = "-POOnly";
	...
	public void initialize_RequiredODSS() throws Exception{
		...
		//set POOnly to True
		Assert.assertTrue(
				foProj.submitAward_ODSS("ODSS-Standard-Award", 1, true,IGeneralConst.postAwardFormName, true, true, true),
	...
	public void onDemandForm_PA() throws Exception {
		...
		//On Demand should not be visible
