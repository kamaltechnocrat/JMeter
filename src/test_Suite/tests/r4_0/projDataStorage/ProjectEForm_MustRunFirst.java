...
public class ProjectEForm_MustRunFirst
{
	...
	public void configureLBF_FOPP() throws Exception
	{
		try
		{
			...
			lbf.setEFormData(ILBFunctionConst.lbf_SubmissionEqualELists[0][0]);

			lbf.setEFormData(ILBFunctionConst.lbf_StandardAwardEqualELists[0][0]);
