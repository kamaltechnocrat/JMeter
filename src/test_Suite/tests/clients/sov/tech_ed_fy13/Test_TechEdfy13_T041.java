...
public class Test_TechEdfy13_T041 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			sov = SovUtils.techEdFy13_Initialization(ESovFOPPs.TechEdFY13, ESovTechEdApplicantsNum.T041, "Grant Application", "TEE Q3_3330");
...
//			Assert.assertTrue(SovUtils.techEdFy13_SubmitPAQuarterlyFinancialReport(sov), "FAIL: to Submit PA Quarterly Financial Report");
			...
			sov.setProjAndSubName("Canaan Schools' Vocational Programs".concat(" - ").concat(sov.getSubProjectName()));
