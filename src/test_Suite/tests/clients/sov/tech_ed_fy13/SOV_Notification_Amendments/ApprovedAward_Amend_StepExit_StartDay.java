...
public class ApprovedAward_Amend_StepExit_StartDay{
	...
	public void setUp() throws Exception {
		...
		try {
			...
			// -----------------------------------
			sov = SovUtils.techEdFy13_Initialization(ESovFOPPs.TechEdFY13, ESovTechEdApplicantsNum.U007, "Finance Create Submission Schedule", "TEE Miss FY13");
	...
	public void amendApprovedAward() throws Exception{
		
       foProj.setProjFullName("TEE Miss FY13 Approved Award-25");
		...
		Assert.assertTrue(SovUtils.amendment_SOV(sov,0,"Approved Award"), "FAIL: to amend Approved Award step");
		
	}
	
	
	@Test(groups = { "SovRegTest" }, dataProvider = "NotifNameIndex", dependsOnMethods = { "amendApprovedAward" }, enabled = true)
	public void verifyApproveAwardAmendNotif(int NotifIndex, int entryCount,
