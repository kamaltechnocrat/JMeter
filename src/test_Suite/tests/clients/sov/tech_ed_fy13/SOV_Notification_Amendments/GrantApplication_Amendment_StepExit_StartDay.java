...
public class GrantApplication_Amendment_StepExit_StartDay {
	...
	public void amendApplication_Reopened() throws Exception{
		
		foProj.setProjFullName("TEE SoWes FY13 Grant Application ReOpened-03");
		...
		Assert.assertTrue(SovUtils.amendment_SOV(sov,0,"Grant Application"), "FAIL: to amend Grant Application step");
		
	}
	
	
	@Test(groups = { "SovRegTest" }, dataProvider = "NotifNameIndex", dependsOnMethods = { "amendApplication_Reopened" }, enabled = true)
