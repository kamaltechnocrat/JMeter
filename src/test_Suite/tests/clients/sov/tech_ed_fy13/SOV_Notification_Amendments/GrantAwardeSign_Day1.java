...
public class GrantAwardeSign_Day1 {
	...
	public static Object[][] generateNotifNameIndex() throws Exception {
		...
		return new Object[][] { { 10, 0, true }

		};
}
	
	@Test(groups = { "SovRegTest" },dependsOnMethods = { "verifyApplicationRequestNotif" })
	public void submitGrantAwardESign() throws Exception{
		
		GeneralUtil.switchToFOOnly();
		
		GeneralUtil.loginAnyFO(judithDenova);
		
		sov.setCurrStepName(ISovConst.sovTechEdStepsNames[7]);
		
		Assert.assertTrue(SovUtils.cfpFY14_SubmitGrantAwardESign_applicant_JudithDenovo(sov, "Approved"), "FAIL: to Submit Grant Award ESign");
