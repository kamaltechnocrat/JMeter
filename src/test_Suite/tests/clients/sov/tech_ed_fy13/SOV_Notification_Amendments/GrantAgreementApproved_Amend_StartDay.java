...
public class GrantAgreementApproved_Amend_StartDay {
	...
	public void amendGrantAgreementCreated() throws Exception{
		...
		Assert.assertTrue(SovUtils.amendment_SOV(sov,0,"Grant Agreement Approved"), "FAIL: to amend TEE Hart FY13 step");
