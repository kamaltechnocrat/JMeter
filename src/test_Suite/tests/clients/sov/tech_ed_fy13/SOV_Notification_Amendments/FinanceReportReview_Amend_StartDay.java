...
public class FinanceReportReview_Amend_StartDay {
	...
	public void amendFinanceReportReview() throws Exception{
		
        foProj.setProjFullName("TEE RBend FY13 Finance Report-39");
		...
		Assert.assertTrue(SovUtils.amendment_SOV_PA(sov,0,"TEE Q2_3330","Finance Report Review"), "FAIL: to amend TEE RBend FY13 step");
		
	}
	
	
	@Test(groups = { "SovRegTest" }, dataProvider = "NotifNameIndex", dependsOnMethods = { "amendFinanceReportReview" }, enabled = true)
