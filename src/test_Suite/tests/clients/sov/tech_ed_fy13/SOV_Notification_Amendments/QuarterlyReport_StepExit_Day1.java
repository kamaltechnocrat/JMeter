...
public class QuarterlyReport_StepExit_Day1 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			// -----------------------------------
			sov = SovUtils.techEdFy13_Initialization(ESovFOPPs.TechEdFY13, ESovTechEdApplicantsNum.T173, "Quarterly Financial Reports", "TEE Q2_3330");
