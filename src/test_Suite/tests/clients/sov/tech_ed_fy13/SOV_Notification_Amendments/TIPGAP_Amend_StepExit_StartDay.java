...
public class TIPGAP_Amend_StepExit_StartDay {
	...
	public void amendTIPGAP_Payment() throws Exception{
		
        foProj.setProjFullName("TEE RVall FY13 TIPGAP Amendment-42");
		...
		Assert.assertTrue(SovUtils.amendment_SOV_PA(sov,0,"TEE Q3_3330","TIPGAP Payment"), "FAIL: to amend TEE RVall FY13 step");
		
	}
	
	
	@Test(groups = { "SovRegTest" }, dataProvider = "NotifNameIndex", dependsOnMethods = { "amendTIPGAP_Payment" }, enabled = true)
