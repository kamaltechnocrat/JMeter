...
public class SubmissionSchedule_Amendment_StepExit_StartDay{
	...
	public void setUp() throws Exception {
		...
		try {
			...
			// -----------------------------------
			sov = SovUtils.techEdFy13_Initialization(ESovFOPPs.TechEdFY13, ESovTechEdApplicantsNum.U048, "Quarterly Financial Reports Loop", "TEE Nowest FY13");
	...
	public void amendSubmissionSchedule() throws Exception{
		
		foProj.setProjFullName("TEE Nowest FY13 Submission Schedule-30");
		...
		Assert.assertTrue(SovUtils.amendment_SOV(sov,0,"Finance Create Submission Schedule"), "FAIL: to amend Approved Award step");
		
	}
	
	
	@Test(groups = { "SovRegTest" }, dataProvider = "NotifNameIndex", dependsOnMethods = { "amendSubmissionSchedule" }, enabled = true)
	public void verifySubmissionSchedule(int NotifIndex, int entryCount,
