...
public class ProgramTeamReview_Amendment {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			// -----------------------------------
			sov = SovUtils.techEdFy13_Initialization(ESovFOPPs.TechEdFY13, ESovTechEdApplicantsNum.U022, "Program Team Review", "");
	...
	public void amendApplication_Reopened() throws Exception{
		...
		foProj.setProjFullName("TTT NoCo FY13 Program Team Review-08");
		...
		Assert.assertTrue(SovUtils.amendment_SOV(sov,0,"Program Team Review"), "FAIL: to amend Program Team Review");
