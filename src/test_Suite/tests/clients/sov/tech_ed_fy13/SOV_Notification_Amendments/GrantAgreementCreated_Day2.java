...
public class GrantAgreementCreated_Day2 {
	...
	@Test(groups = { "SovRegTest" }, dataProvider = "NotifNameIndexGAC",enabled = true)
	public void verifySubmissionNotif(int NotifIndex, int entryCount,
	...
	@Test(groups = { "SovRegTest" }, dataProvider = "NotifNameIndex", dependsOnMethods = { "verifySubmissionNotif" }, enabled = true)
	public void verifyFinanceReviewNotif(int NotifIndex, int entryCount,
			boolean resultExpected) throws Exception {
		try {
			GeneralUtil.switchToPOOnly();
			...
			Assert.assertTrue(NotificationsUtil.openNotificationLogInProject_New(
					foProj, ISovConst.sovTechEdStepsNames[4]),
					"FAIL: Could not open the notification log");
	...
	public static Object[][] generateNotifNameIndexFinanceReview() throws Exception {

		return new Object[][] { { 7, 6, true }

		};
    }
	

	@DataProvider(name = "NotifNameIndexGAC")
	public static Object[][] generateNotifNameIndexGAC() throws Exception {

		return new Object[][] { { 6, 0, true }
