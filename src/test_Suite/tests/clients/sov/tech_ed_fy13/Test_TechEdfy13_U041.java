...
public class Test_TechEdfy13_U041 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			sov = SovUtils.techEdFy13_Initialization(ESovFOPPs.TechEdFY13, ESovTechEdApplicantsNum.U041, "Grant Application", "TEE Q4_3330");
			
			sov.setFoProjName(sov.getProjectName().concat(" - Equipment Grant request"));
