...
public class Test_CFPfy14_SU003_dms {
	...
	public void requestAmendmentNG() throws Exception {
		
		try {
			
			Assert.assertTrue(SovUtils.amendApplicationSubmission(sov), "FAIL: unable to request amendment");
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "SovRegTest" }, dependsOnMethods = {"requestAmendmentNG"})
