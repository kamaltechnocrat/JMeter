...
public class Test_CFPfy13_SU005 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			sov = SovUtils.cfpFy13_Initialization(ESovFOPPs.CFPFY13DOE, ESovCfpFy13ApplicantsNum.SU005, "CFP Application", "Title IIA - Final FN_4651");
			
			sov.setFoProjName(sov.getProjectName().concat("SVSU"));
	...
	public void testCaseTemplateNG() throws Exception {
		try {
			...
			sov.setProjectName(ISovConst.sovCfpFy13ProjectsNames[ISovConst.ESovCfpFy13ApplicantsNum.SU005.ordinal()]);
