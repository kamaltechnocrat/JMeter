...
public class Test_CFPfy13_SU023 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			sov = SovUtils.cfpFy13_Initialization(ESovFOPPs.CFPFY13DOE, ESovCfpFy13ApplicantsNum.SU023, "CFP Application", "Title I - Q4_4250");
	...
	public void testCaseTemplateNG() throws Exception {
		try {
			...
			sov.setProjectName(ISovConst.sovCfpFy13ProjectsNames[ISovConst.ESovCfpFy13ApplicantsNum.SU023.ordinal()]);
