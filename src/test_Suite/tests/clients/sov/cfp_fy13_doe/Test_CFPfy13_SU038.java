...
public class Test_CFPfy13_SU038 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			sov = SovUtils.cfpFy13_Initialization(ESovFOPPs.CFPFY13DOE, ESovCfpFy13ApplicantsNum.SU038, "CFP Application", "Title IIA - Final FN_4651");
	...
	public void testCaseTemplateNG() throws Exception {
		try {
			...
			sov.setProjectName(ISovConst.sovCfpFy13ProjectsNames[ISovConst.ESovCfpFy13ApplicantsNum.SU038.ordinal()]);
