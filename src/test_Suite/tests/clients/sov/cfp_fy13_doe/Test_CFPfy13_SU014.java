...
public class Test_CFPfy13_SU014 {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			sov = SovUtils.cfpFy13_Initialization(ESovFOPPs.CFPFY13DOE, ESovCfpFy13ApplicantsNum.SU014, "CFP Application", "Title IIA - Final FN_4651");
...
//			GeneralUtil.LoginAny(poOfficer1);			
			...
			sov.setProjectName(ISovConst.sovCfpFy13ProjectsNames[ISovConst.ESovCfpFy13ApplicantsNum.SU014.ordinal()]);
