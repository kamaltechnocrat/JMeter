...
public class Data_Archive_TestScheduledForDeletionProjects {
	...
	public void prepProjects() throws Exception {
		...
		Assert.assertTrue(FiltersUtil.filterProjListByNameAndStatus(IGeneralConst.da_projectStatus_lbl, IGeneralConst.archived_dd,
				IGeneralConst.da_projectName_lbl, "", "Contains"), "Fail: Couldn't filter by Project name and status!");
		...
		Assert.assertTrue(GeneralUtil.da_filterProjs_ChangeState(foundProj, IGeneralConst.archived_dd, IClicksConst.processDelete_Id), 
				"Fail: Could not filter and change state of Project! to Scheduled for Deletion!");
	}
