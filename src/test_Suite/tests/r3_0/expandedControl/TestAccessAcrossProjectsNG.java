...
public class TestAccessAcrossProjectsNG {
	...
	public void createFOProjectNG() throws Exception {
		try {
			...
			foProj = new FOProject(fopp, "", true, 2, "-AcrossProjects");
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="rejectApprovalNG", dataProvider="subs")
	public void testAccessToMyProjectsLists(String loginName,String stepName, boolean expected) throws Exception {
	...
	public void testAccessToProjectsLists() throws Exception {
		...
		try {
			...
			GeneralUtil.switchToPOOnly();
			GeneralUtil.LoginAny("northuser1");
			
			Assert.assertFalse(ProjActivUtil.openProjectActivity(foProj.getProjFOFullName(), IFiltersConst.openProjView),"FAIL: should not have access to Project because of Org high");
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="testAccessToProjectsLists")
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="amendApplicationSubmission", dataProvider="icons")
	public void testAccessToAmendmentsLists(String loginName,EAmendListIcons icon, boolean expected) throws Exception {
	...
	public Object[][] generateSteps() {
		...
		result = new Object[][] {
				new Object[] {"eastuser1",IGeneralConst.approvQuoCritAuto[0][0],false},
				new Object[] {"FinancialOfficer1",IGeneralConst.gnrl_SubmissionA[0][0],true}
		};		
	...
	public Object[][] generateIcons() {
		...
		result = new Object[][] {
				new Object[] {"eastuser2",EAmendListIcons.cancel, false},
				new Object[] {"FinancialOfficer3",EAmendListIcons.details,true},
				new Object[] {"northuser1",EAmendListIcons.submission,false}
		};		
