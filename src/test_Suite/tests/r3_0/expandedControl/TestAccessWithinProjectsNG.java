...
public class TestAccessWithinProjectsNG {
	...
	public void createFOProjectNG() throws Exception {
		try {
			...
			foProj = new FOProject(fopp, "", true, 2, "-WithinProjects");
	...
	public void testAssignedEvalsAccessToMyProjectsLists(String stepName, boolean expected) throws Exception {
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="testAssignedEvalsAccessToMyProjectsLists")
	public void testAssignedEvalsAccessToProjectsLists() throws Exception {
		
		try {
			
			Assert.assertTrue(ProjActivUtil.openProjectActivity(foProj.getProjFOFullName(), IFiltersConst.openProjView),"FAIL: could not open Project Activity page");
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="testAssignedEvalsAccessToProjectsLists")
	...
	public void testAssignedEvalsAccessToAmendmentsLists(EAmendListIcons icon, boolean expected) throws Exception {
	...
	public Object[][] generateIcons() {
		...
		result = new Object[][] {
				new Object[] {EAmendListIcons.cancel, true},
				new Object[] {EAmendListIcons.details,true},
