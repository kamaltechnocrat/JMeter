...
public class TestOtherStepStaffAccessWithingProjectsNG {
	...
	public void createFOProjectNG() throws Exception {
		try {
			...
			foProj = new FOProject(fopp, "", true, 2, "-Other-SS-WithingProjs");
	...
	public Object[][] generateSteps() {
		...
		result = new Object[][] {
				...
				new Object[] {"FinancialOfficer1",IGeneralConst.gnrl_SubmissionA[0][0],false}
		};		
	...
	public Object[][] generateIcons() {
		...
		result = new Object[][] {
				...
				new Object[] {"FinancialOfficer3",EAmendListIcons.details,false},
