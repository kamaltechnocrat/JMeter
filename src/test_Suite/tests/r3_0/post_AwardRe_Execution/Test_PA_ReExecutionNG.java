...
public class Test_PA_ReExecutionNG {
	...
	public void submitAward() throws Exception {
		try {
			...
			foProj.changeClaimCriteria(true, false, false, ILBFunctionConst.lbf_IPASSource[1][0], "PA Submission Schedule Fields LBF");
			...
			SubAccessUtil.continuePAWorkflow(foProj, 1, true, false, IFiltersConst.submissionsStatus_Ready_StatusSubView, "1", IFiltersConst.versionNumber_EqualTo);
	...
	public void requestAmendmentOnAward() throws Exception {
		...
		hashList.add(0,SubAccessUtil.initializePA_Optional(foProj,false,true));
		
		hashList.add(1,SubAccessUtil.initializePA_Optional(foProj,true,false));
