...
public class TestPASubVersionInLists {
	...
	public void testSVInFoSubmissionListNG() throws Exception {
		...
		Assert.assertTrue(FrontOfficeUtil.openFOSubmissionForm(foProj, ILBFunctionConst.lbf_IPASSource[0][0]), "FAIL: Could not Open Submission In FO!");
	...
	public void testSVInMyAssignedSubmissionsNG() throws Exception {
		...
		foProj.initializeStep(IGeneralConst.PO_Submission_Non[0][0].concat(paStep));
		...
		ProjectUtil.openSubmissionInMyAssignedSubmissionList(foProj, IGeneralConst.PO_Submission_Non[0][0].concat(paStep), IFiltersConst.openProjView);
	...
	public void testSVInEvaluateSubmissionNG() throws Exception {
		...
		foProj.initializeStep(IGeneralConst.approvQuoCritAuto[0][0].concat(paStep));
		...
		ProjectUtil.openEvaluateSubmissionFormletInList(foProj, IGeneralConst.approvQuoCritAuto[0][0].concat(paStep), IFiltersConst.submissionsStatus_Ready_StatusSubView, "No Propreties Fields LBF", false);
