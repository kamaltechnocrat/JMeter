...
public class TestExitEvaluationStepOnReExecutionNG {
	...
	public void createFOProjectNG() throws Exception {
		try {
			...
			foProj = new FOProject(fopp, "", true, 2, "-ExitEvalReExec");
	...
	public void openEvaluationAmendedSubmissions(String userBeat, String approved, String subStatus, boolean expected, boolean doSubmit) throws Exception {
	...
	public Object[][] generateApproval() {
		...
		result = new Object[][] {
				new Object[] {"1","Rejected",IFiltersConst.evaluateSubmissions_InProgress_StatusSubView,true,true},
				new Object[] {"2","Approved",IFiltersConst.evaluateSubmissions_InProgress_StatusSubView,true,true},
				new Object[] {"3","Rejected",IFiltersConst.evaluateSubmissions_NotUsed_StatusSubView,true,false},
				new Object[] {"4","Rejected",IFiltersConst.evaluateSubmissions_NotUsed_StatusSubView,true,false},
				new Object[] {"5","Rejected",IFiltersConst.evaluateSubmissions_NotUsed_StatusSubView,true,false}
		};				
		return result;		
	}
