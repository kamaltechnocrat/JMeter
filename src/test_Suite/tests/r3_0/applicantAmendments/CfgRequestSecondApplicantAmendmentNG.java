...
public class CfgRequestSecondApplicantAmendmentNG {
	...
	public void requestFirstApplicantAmendment() throws Exception {
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods = "requestFirstApplicantAmendment")
	public void requestSecondApplicantAmendment() throws Exception {
		...
		try {
			...
			AmendmentsUtil.openApplicantAmendment(obj,EAmendmentOptions.REQUEST);
			
			Assert.assertTrue(GeneralUtil.FindTextOnPage("The submission cannot be amended."));
