...
public class TestInternalFoppNG {
	...
	public void setUp() {
		...
		try {
			...
			Assert.assertTrue(FOPPUtil.changeFoppStatusAndHideProjects(fopp, IFoppConst.E3StatesFopp.internal,showHistoricalProj), "FAIL: error occur during the process of changing Funding State!");
