 ...
 * 
 */
public class InitialPostAwardScheduleDueNotification {
	// #####***********************************************************************
	// ### To set up the Global Params Name Vars
	// #####***********************************************************************
	Class<?> InitialPostAwardScheduleDueNotification = this.getClass();

	private Log log = LogFactory.getLog(InitialPostAwardScheduleDueNotification);
	...
	String paCurrentStep = "Inital-PostAward Submission Schedule Due";
