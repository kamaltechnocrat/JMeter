 ...
 *
 */
public class VerifyFalseValueConditionalNotification {
	// #####***********************************************************************
		// ### To set up the Global Params Name Vars
		// #####***********************************************************************
		Class<?> VerifyFalseValueConditionalNotification = this.getClass();

		private Log log = LogFactory.getLog(VerifyFalseValueConditionalNotification);
		...
		String paCurrentStep = "Inital-PostAward False Value Conditional Submission Schedule Due";
		...
		public void openFOPPAndAddInitialPostAwardNotificationAtPO()
			...
			try {
				...
				Assert.assertTrue(ProgStepUtil.addConditionalNotification(
						...
						INotificationsConst.ntfExpressionValue1));
		...
		public void verifyNotificationLogInProejects() throws Exception {
			try {
				...
				Assert.assertFalse(ProjectUtil.verifyNotificationLogEntries(
						...
						"FAIL: False Value Conditional Schedule due Notification in Notification Log");
			} catch (Exception e) {
				Assert.fail("Unexpected Exception: ", e);
			}
