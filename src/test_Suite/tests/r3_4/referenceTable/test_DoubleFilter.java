...
public class test_DoubleFilter 
{
	...
	// #####***********************************************************************
		...
		public void testDoubleFilters_CapitalEquipment() throws Exception{
			
		
			ClicksUtil.clickLinks(IClicksConst.diagEFormsLnk);
			
			Assert.assertTrue(EFormsUtil.openEFormPreviewInList("Reference-Double-Filter",
					"Review"));
