...
public class BulkEvalPreAwardApprovalSteps {
	...
	private String projType = "PreAward";
	...
	public void setUp() {
		try {
			...
			foProj.setProgFullName(fopp.getFoppFullName());
	...
	public void prepProject() throws Exception{
		...
		foProj.setProjFOFullName(foundProj);
