...
public class ReviewStepAmendDue_3rdDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Review-Amend-due-", true, 1,
					"-38");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyNotifStepEntryAfterJobRun", enabled = true)
	public void evaluateSubmission() throws Exception {
		try {
			...
			Assert.assertTrue(foProj.reviewAmendedSubmission(IGeneralConst.reviewQuoCritAuto[0][0], true), "FAIL: Could not resubmit review step!");
