...
public class StepEntyNotifOnlyToStepEval {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Approval-Step-Entry-", true, 1, "-32");
	...
	public void verifyNotifStepEntryBeforeJobRun() throws Exception {
		try {
			...
			Assert.assertEquals(NotificationsUtil.verifyNotificationLogEntries(
					INotificationsConst.notifyEvalPAFOPPNotificationName[1],
