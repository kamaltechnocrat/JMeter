...
public class PAReviewStepAmendNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PA-Review-Step-Amend-", true,
					1, "-37");
	...
	public void verifyNotifAmendBeforeJobRun() throws Exception {
		try {
			...
			Assert.assertEquals(NotificationsUtil.verifyNotificationLogEntries(
					INotificationsConst.notifyEvalPAFOPPNotificationName[3],
