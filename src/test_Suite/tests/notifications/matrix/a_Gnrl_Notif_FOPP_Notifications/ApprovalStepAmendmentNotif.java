...
public class ApprovalStepAmendmentNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Approval-Step-Amend-", true, 1,"-15");
	...
	public void runNotifQuartzJobForEvalNeeded() throws Exception {
		try {
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "runNotifQuartzJobForEvalNeeded", enabled = true)
	...
	public void verifyNotifAmendNoJobRun(int NotifIndex, int entryCount, boolean resultExpected) throws Exception {
		try {
