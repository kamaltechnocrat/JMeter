...
public class StepEntryImmediateAwardStepNotification {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Step-Entry-Immed-",true, 1, "-05");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "assignEvaluatorAndEvaluateSubmission" },dataProvider="NotifNameIndex", enabled = true)
