...
public class AwardAmendmentStepExitNotif_1stDay {
	// #####***********************************************************************
	...
	// To verify the step exit-immediate notification afer re-submitting the
	// award step
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "reSubmitAward" },dataProvider="NotifNameIndex", enabled = true)
	public void verifyNotifExitAfterResubmit(int NotifIndex, int entryCount, boolean resultExpected) throws Exception {
		try {
