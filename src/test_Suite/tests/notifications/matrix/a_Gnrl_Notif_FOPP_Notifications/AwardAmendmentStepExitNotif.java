...
public class AwardAmendmentStepExitNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp,
					"Award-Amend-Step-Exit-", true, 1, "-18");
	...
	public void verifyNotifExitNoJobRun() throws Exception {
		try {

			Assert.assertEquals(NotificationsUtil.verifyNotificationLogEntries(
					INotificationsConst.gnrlNotifFOPPNotificationsName[6],
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "verifyNotifExitNoJobRun" }, enabled = true)
	...
	public void verifyNotifAmendBeforeJobRun() throws Exception {
		try {
			...
			Assert.assertEquals(NotificationsUtil.verifyNotificationLogEntries(
					INotificationsConst.gnrlNotifFOPPNotificationsName[8],
	...
	// the below method to fire the amendment notification for Award step
