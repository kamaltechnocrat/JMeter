...
public class ReviewStepAmendmentNotification {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Review-Step-Amend-",true, 1, "-14");
	...
	public void verifyNotifGrpAssignBeforeJobRun() throws Exception {
		try {
			...
			Assert.assertEquals(NotificationsUtil.verifyNotificationLogEntries(
					INotificationsConst.gnrlNotifFOPPNotificationsName[2],
