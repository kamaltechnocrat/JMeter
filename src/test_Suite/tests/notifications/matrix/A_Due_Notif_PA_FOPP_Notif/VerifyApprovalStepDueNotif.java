...
public class VerifyApprovalStepDueNotif {
	// #####***********************************************************************
	// ### To set up the Global Params Name Vars
	// #####***********************************************************************
	Class<?> VerifyApprovalStepDueNotif = this.getClass();

	private Log log = LogFactory.getLog(VerifyApprovalStepDueNotif);

	FundingOpportunity fopp;

	FOProject foProj;
	
	String propKey = "scenario08";
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Approval-Step-Due-", true, 1,	"-8");
	...
	public void verifyNotifStepDueBeforeJobRun(int NotifIndex, int entryCount, boolean resultExpected) throws Exception {
		try {
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyNotifStepDueBeforeJobRun", enabled = true)
	...
	public void verifyNotifStepDueAfterJobRun(int NotifIndex, int entryCount, boolean resultExpected) throws Exception {
		try {
