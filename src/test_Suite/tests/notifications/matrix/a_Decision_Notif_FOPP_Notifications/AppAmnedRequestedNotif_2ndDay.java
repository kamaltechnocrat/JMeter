...
public class AppAmnedRequestedNotif_2ndDay {
	...
	@Test(groups = { "NotificationWorkFlow" })
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyNotifRequestedAfterJobRun", enabled = true)
	public void rejectApplicantAmendRequest() throws Exception {
		try {

			String dd = GeneralUtil.setDayofMonth(3);
			String amender = "FO: ".concat(IPreTestConst.FrontUsers[1][2]).concat("1, ").concat(IPreTestConst.FrontUsers[1][1])
					.concat("1 (").concat(IPreTestConst.FrontUsers[1][0]).concat("1").concat(IPreTestConst.FrontUsers[1][3])
					.concat(")");
