...
public class AppAmndReqRejectedNotif_1stDay {
	// #####***********************************************************************
	...
	public void verifyNotifRegectedNextDay(int NotifIndex, int entryCount, boolean resultExpected) throws Exception {
		try {
