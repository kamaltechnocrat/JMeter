...
public class ApprovalStepAmendNotifOnly_4thDay {
	// #####***********************************************************************
	...
	public void verifyNotifAmendNextDay(int NotifIndex, int entryCount, boolean resultExpected) throws Exception {
		try {
