...
public class ReviewStepEvaluatorAssignedNotif {
	// #####***********************************************************************
		...
		public void setUp() throws Exception {
			...
			try {
				...
				foProj = new FOProject(fopp, "Review-Step-Eval-Assign-",true, 1, "-04");
		...
		public void verifyNotifEvalAssignBeforeJobRun() throws Exception {
			try {
				...
				Assert.assertEquals(NotificationsUtil.verifyNotificationLogEntries(
						INotificationsConst.notifAmendFOPPNotificationName[0],
		...
		public void verifyNotifEvalAssignAfterJobRun(int NotifIndex, int entryCount, boolean resultExpected) throws Exception {
			try {
