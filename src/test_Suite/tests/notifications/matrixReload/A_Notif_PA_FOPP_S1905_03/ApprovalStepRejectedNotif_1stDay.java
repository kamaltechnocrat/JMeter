...
public class ApprovalStepRejectedNotif_1stDay {
	// #####***********************************************************************
			...
			public void setUp() throws Exception {
				...
				try {
					...
					foProj = new FOProject(fopp, "Approval-Step-Rejected-", true,
							1, "-87");
			...
			public void verifyApprovalStepRejectedNotifNextDay(int NotifIndex, int entryCount,
