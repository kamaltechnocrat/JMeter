...
public class ApprovalStepEvalAssignedNotif_1stDay {
	// #####***********************************************************************
			...
			public void setUp() throws Exception {
				...
				try {
					...
					foProj = new FOProject(fopp, "ApprovalStep-Eval-Assigned-", true, 1,
							"-86");
