...
public class ReviewStepEvalNeededNotif_3rdDay {
	// #####***********************************************************************
				...
				public void setUp() throws Exception {
					...
					try {
						...
						foProj = new FOProject(fopp, "ReviewStep-Eval-Needed-", true, 1, "-83");
				...
				public void verifyEvalNeededNotifNext3rdDayAfterEvalAssigned(int NotifIndex, int entryCount,
