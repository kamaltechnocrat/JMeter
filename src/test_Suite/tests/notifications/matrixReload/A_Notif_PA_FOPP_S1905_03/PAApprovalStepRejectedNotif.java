...
public class PAApprovalStepRejectedNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAApproval-Step-Rejected-", true, 1,
					"-92");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "assignEvaluatorToPAStep", dataProvider = "ApproverBeat", enabled = true)
	public void paApprovalRejected(String userBeat) throws Exception {
		try {
			...
			Assert.assertTrue(foProj
					.rejectSubmission(IGeneralConst.approvQuoCritManu[0][0]
							+ newPASuffix));
