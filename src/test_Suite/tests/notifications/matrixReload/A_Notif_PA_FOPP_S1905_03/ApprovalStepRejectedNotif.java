...
public class ApprovalStepRejectedNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Approval-Step-Rejected-", true, 1,
					"-87");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "evaluateSubmission", dataProvider = "ApproverBeat", enabled = true)
	public void approvalRejected(String userBeat) throws Exception {
		try {
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "approvalRejected" }, dataProvider = "NotifNameIndex", enabled = true)
	...
	public static Object[][] generateNotifNameIndex() throws Exception {
		...
		return new Object[][] { { 4, 7, true }

		};
	}

	@DataProvider(name = "ApproverBeat")
	public static Object[][] generateApproverBeat() throws Exception {
