...
public class ApprovalStepEvalAssignedNotif {
	// #####***********************************************************************
		...
		public void setUp() throws Exception {
			...
			try {
				...
				foProj = new FOProject(fopp, "ApprovalStep-Eval-Assigned-", true,
						1, "-86");
		...
		public void verifyEvalAssignedNotif(int NotifIndex, int entryCount,
