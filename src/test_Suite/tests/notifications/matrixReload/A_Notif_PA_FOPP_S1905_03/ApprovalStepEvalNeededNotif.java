...
public class ApprovalStepEvalNeededNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "ApprovalStep-Eval-Needed-", true, 1,
					"-85");
	...
	public void verifyEvalNeededNotifBeforeJobRun(int NotifIndex,
	...
	public void verifyEvalNeededNotifAfterJobRun(int NotifIndex,
			int entryCount, boolean resultExpected) throws Exception {
		try {
