...
public class PAReviewEvalAssignedNotif_1stDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAReviewStep-Eval-Assigned-", true,
					1, "-89");
	...
	public void verifyEvalAssignedNotifNextDay(int NotifIndex, int entryCount,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyEvalAssignedNotifNextDay", enabled = true)
	public void reviewInitialClaim() throws Exception {
		try {
			...
			Assert.assertTrue(foProj.reviewSubmission(
					IGeneralConst.reviewQuoCritAuto[0][0] + newPASuffix,
					true, "Yes", false,
