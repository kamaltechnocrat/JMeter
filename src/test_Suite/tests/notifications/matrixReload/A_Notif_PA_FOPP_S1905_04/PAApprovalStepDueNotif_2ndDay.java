...
public class PAApprovalStepDueNotif_2ndDay {
	// #####***********************************************************************
		...
		public void setUp() throws Exception {
			...
			try {
				...
				foProj = new FOProject(fopp, "PAApproval-Step-Due-", true, 1,
						"-100");
		...
		public void verifyStepDueNotifOn2ndDay(int NotifIndex,
