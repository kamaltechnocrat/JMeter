...
public class IPASScheduleDueNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "IPASS-Schedule-Due-Notif", true, 1,
					"-110");
	...
	public void verifyIPASSubDueNotifOn2ndDay(int NotifIndex, int entryCount,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyIPASSubDueNotifOn2ndDay", enabled = true)
