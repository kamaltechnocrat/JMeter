...
public class ApprovalStepEntryNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Approval-Step-Entry-Notif", true, 1,
					"-114");
	...
	public void verifyApprovalStepEntryNotifBeforeJobRun(int NotifIndex,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyApprovalStepEntryNotifBeforeJobRun", enabled = true)
	...
	public void verifyApprovalStepEntryNotifAfterJobRun(int NotifIndex,
			int entryCount, boolean resultExpected) throws Exception {
		try {
