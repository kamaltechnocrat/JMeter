...
public class ReviewAmendReqNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Review-Amend-Request-", true, 1,
					"-69");
	...
	public void verifyAmendRequestNotifOn2ndDay(int NotifIndex, int entryCount,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyAmendRequestNotifOn2ndDay", enabled = true)
	public void evaluateSubmission() throws Exception {
		try {
			...
			Assert.assertTrue(foProj.reviewAmendedSubmission(
					IGeneralConst.reviewQuoCritManu[0][0], true));
