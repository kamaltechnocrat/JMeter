...
public class IPASSAppAmendReqNotif_2ndDay {
	// #####***********************************************************************
		...
		public void setUp() throws Exception {
			...
			try {
				...
				foProj = new FOProject(fopp, "IPASS-AppAmend-Req-", true, 1, "-101");
		...
		public void verifyAmendReqNotifOn2ndDay(int NotifIndex, int entryCount,
		...
		@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyAmendReqNotifOn2ndDay", enabled = true)
		public void approveApplicantAmendRequest() throws Exception {
			try {
				...
				String amender = "Applicant:".concat(foProj.getFoApplicantName("front")).concat("(")
				...
				Assert.assertTrue(AmendmentsUtil.approveOrRejectAmendmentRequest(
						foProj, new String[] { amender,
								IPreTestConst.Groups[0][0][0], dd, "Approved",
								"This is Approve Reason",
