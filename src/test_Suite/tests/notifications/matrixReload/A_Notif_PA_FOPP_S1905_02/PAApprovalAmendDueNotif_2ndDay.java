...
public class PAApprovalAmendDueNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAApproval-Amend-Due-", true, 1,
					"-82");
	...
	public void approveAmendedInitialClaim() throws Exception {
		try {
