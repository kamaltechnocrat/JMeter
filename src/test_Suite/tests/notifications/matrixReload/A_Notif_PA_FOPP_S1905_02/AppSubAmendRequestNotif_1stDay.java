...
public class AppSubAmendRequestNotif_1stDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "AppSub-Amend-Request-", true, 1,
					"-67");
	...
	public void verifyAmendRequestNotifNextDay(int NotifIndex, int entryCount,
