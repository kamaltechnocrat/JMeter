...
public class PAReviewAmendDueNotif_1stDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAReview-Amend-Due-", true, 1, "-80");
	...
	public void verifyAmendDueNotifNextDay(int NotifIndex, int entryCount,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyAmendDueNotifNextDay", enabled = true)
