...
public class PAApprovalAmendReqNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAApproval-Amend-Req-", true, 1,
					"-81");
	...
	public void verifyAmendReqNotif2ndDay(int NotifIndex, int entryCount,
