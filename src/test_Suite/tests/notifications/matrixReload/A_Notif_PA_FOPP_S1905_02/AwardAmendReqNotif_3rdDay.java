...
public class AwardAmendReqNotif_3rdDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Award-Amend-Req-", true, 1, "-73");
	...
	public void verifyAmendReqNotifOn3rdDay(int NotifIndex, int entryCount,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "verifyAmendReqNotifOn3rdDay" }, enabled = true)
	public void resubmitAwardStep() throws Exception {
		try {
			...
			Assert.assertTrue(foProj.reSubmitAnyStandardAgreement(
					IGeneralConst.pa_AwardCrit[0][0], true),
					"FAIL: Could not resubmit Award step!");
