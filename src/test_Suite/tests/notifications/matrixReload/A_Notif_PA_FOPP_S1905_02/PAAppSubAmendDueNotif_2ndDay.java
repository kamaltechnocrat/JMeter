...
public class PAAppSubAmendDueNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAAppSub-Amend-Due-", true, 1, "-120");
	...
	public void verifyAmendDueNotif2ndDay(int NotifIndex, int entryCount,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyAmendDueNotif2ndDay", enabled = true)
