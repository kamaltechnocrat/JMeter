...
public class ProjActivityTwoDayBeforeNotif {
	// #####***********************************************************************
	...
	String propKey = "scenario106";

	String notify2DayBeforeParams[] = {
			IProjActivConst.projActivity_Details_Type_Email,
			IProjActivConst.projActivity_Details_Type_Email + "-Two Day Before",
			"0", "3", IProjActivConst.projActivity_Details_Status_Caution, "",
			"2", "" };
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "ProjActivity-TwoDayBefore-Notif",
					true, 1, "-106");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "testActivityNotificationsEmailTwoDayBeforeNG" }, dataProvider = "NotifNameIndex", enabled = true)
