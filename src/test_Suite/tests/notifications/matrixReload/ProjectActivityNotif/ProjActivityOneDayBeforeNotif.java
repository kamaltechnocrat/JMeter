...
public class ProjActivityOneDayBeforeNotif {
	// #####***********************************************************************
	...
	String notify1DayBeforeParams[] = {
			...
			IProjActivConst.projActivity_Details_Type_Email +  "-One Day Before",
			"0", "2", IProjActivConst.projActivity_Details_Status_Caution, "",
			"1", "1" };
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "ProjActivity-OneDayBefore-Notif", true,
					1, "-105");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "testActivityNotificationsEmailOneDayBeforeNG" }, dataProvider = "NotifNameIndex", enabled = true)
