...
public class ProjActivityImmediateNotif {
	// #####***********************************************************************
	...
	String notifyImmediateParams[] = {
			...
			IProjActivConst.projActivity_Details_Type_Email + "-Immediate",
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "testActivityNotificationsImmediateEmailNG", enabled = true)
