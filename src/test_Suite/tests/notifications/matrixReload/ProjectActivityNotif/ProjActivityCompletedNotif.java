...
public class ProjActivityCompletedNotif {
	// #####***********************************************************************
	...
	String propKey = "scenario107";

	String notifyCompletedParams[] = {
			IProjActivConst.projActivity_Details_Type_Email,
			IProjActivConst.projActivity_Details_Type_Email + "-Completed",
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "ProjActivity-Completed-Notif", true,
					1, "-107");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "testActivityComlpetedNotificationsEmailNG" }, dataProvider = "NotifNameIndex", enabled = true)
