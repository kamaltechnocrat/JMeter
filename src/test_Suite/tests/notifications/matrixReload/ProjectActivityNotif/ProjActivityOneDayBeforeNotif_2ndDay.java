...
public class ProjActivityOneDayBeforeNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "ProjActivity-OneDayBefore-Notif",
					true, 1, "-105");
	...
	public void verifyProjActivity1DayBeforeNotifOn2ndtDay(int NotifIndex,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "verifyProjActivity1DayBeforeNotifOn2ndtDay" }, enabled = true)
	public void completeScheduledProjActivityNotif() throws Exception {
		try {
	...
	private void initializeProjectActivity() throws Exception {
		...
		projActivity.setActivityCompleted(true);

	}

	private void completeNotifcation() throws Exception {
		...
		Assert.assertTrue(
				ProjActivUtil.CompleteProjectActivityNotifDetails(projActivity),
