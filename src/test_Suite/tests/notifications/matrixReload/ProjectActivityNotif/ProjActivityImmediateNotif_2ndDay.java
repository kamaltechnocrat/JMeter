...
public class ProjActivityImmediateNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "ProjActivity-Immediate-Notif", true,
					1, "-103");
	...
	public void verifyProjActivityImmediateNotifOn2ndDay(int NotifIndex,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "verifyProjActivityImmediateNotifOn2ndDay" }, enabled = true)
