...
public class VerifySubStepExitNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "AppSub-Step-Exit-", true, 1, "-52");
	...
	public void verifyNotifStepExitNextTwoDay(int NotifIndex, int entryCount,
