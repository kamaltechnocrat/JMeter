...
public class IPASStepEntryNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "IPAS-Step-Entry-", true, 1, "-61");
	...
	public void verifyNotifStepEntryNextTwoDayBeforeStepSubmitted(
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyNotifStepEntryNextTwoDayBeforeStepSubmitted", enabled = true)
