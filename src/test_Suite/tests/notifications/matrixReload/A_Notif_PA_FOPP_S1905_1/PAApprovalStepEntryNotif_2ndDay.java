...
public class PAApprovalStepEntryNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAApproval-Step-Entry-", true, 1,
					"-65");
	...
	public void verifyNotifStepEntryNextTwoDayBeforeStepApproved(
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyNotifStepEntryNextTwoDayBeforeStepApproved", enabled = true)
