...
public class PAReviewStepExitNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "PAReview-Step-Exit-", true, 1, "-64");
	...
	public void verifyNotifStepExitOn2ndDay(int NotifIndex, int entryCount,
