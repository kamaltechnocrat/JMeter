...
public class VerifyApprovalStepEntryNotif_2ndDay {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Approval-Step-Entry-", true, 1, "-55");
	...
	public void verifyNotifStepEntryBeforeStepApproved(int NotifIndex,
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = "verifyNotifStepEntryBeforeStepApproved", enabled = true)
