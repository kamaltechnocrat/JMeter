...
public class VerifyApprovalStepExitNotif {
	// #####***********************************************************************
	...
	public void setUp() throws Exception {
		...
		try {
			...
			foProj = new FOProject(fopp, "Approval-Step-Exit-", true, 1, "-56");
	...
	@Test(groups = { "NotificationWorkFlow" }, dependsOnMethods = { "evaluateSubmissions" }, dataProvider = "NotifNameIndex", enabled = true)
	public void verifyNotifStepExitBeforeJobRun(int NotifIndex, int entryCount,
	...
	public void verifyNotifStepExitAfterJobRun(int NotifIndex, int entryCount,
			boolean resultExpected) throws Exception {
		try {
