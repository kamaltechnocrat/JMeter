...
public class LBF_DelRowsTrgt_AmendSrc {
	...
	public void setUp() throws Exception {
		...
		lbf.setEFormType(EeFormsIdentifier.submission);
	...
	public void deleteEntriesFromAwardAndSubmit() throws Exception {
		...
		LBFunctionUtil.insertTo_SubScheduleListFormlet("",lbf);

		lbf.setDeleteRowIndex(0);
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods = "deleteEntriesFromAwardAndSubmit")
	...
	public void testRowsEntriesOnAwardFormNG(
			ILBFunctionConst.EFormletTypes eTypes, int startIndx) throws Exception {
		
		lbf.setRowsAndIndexes(1, startIndx);
		lbf.setEFormletsName(eTypes);
		Assert.assertTrue(lbf.verifyRows());
	}

	@Test(groups = { "EFormsNG" }, dependsOnMethods = "testRowsEntriesOnAwardFormNG", dataProvider = "formletTypes")
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods = "addEntriesAndSubmitIPASS")
	...
	public Object[][] generateFormletTypes() {
		...
		result = new Object[][] {
				new Object[] { ILBFunctionConst.EFormletTypes.noProp, 1 },
				new Object[] { ILBFunctionConst.EFormletTypes.typeProp, 1 },
				new Object[] { ILBFunctionConst.EFormletTypes.minMaxProp, 1 },
				new Object[] { ILBFunctionConst.EFormletTypes.dGrid, 1 },
				new Object[] { ILBFunctionConst.EFormletTypes.attchments, 0 } };
