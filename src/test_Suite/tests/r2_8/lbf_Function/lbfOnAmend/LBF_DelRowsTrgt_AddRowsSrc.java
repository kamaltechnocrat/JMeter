...
public class LBF_DelRowsTrgt_AddRowsSrc {
	...
	public void deleltwEntriesAndSubmitAward() throws Exception {
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods = "deleltwEntriesAndSubmitAward")
