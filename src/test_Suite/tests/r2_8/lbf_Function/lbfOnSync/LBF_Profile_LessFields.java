...
public class LBF_Profile_LessFields {
	...
	String iPASFormIdent = ILBFunctionConst.lbf_IPASLessAttachments[1][0];
	String possFormName = ILBFunctionConst.lbf_POSubmissionLessELists[0][1];
	String possStepName = ILBFunctionConst.lbf_POSubmissionLessELists[0][0];
	...
	public void setUp() throws Exception {
		...
		lbf = new LBF(ILBFunctionConst.ESyncTypes.less.ordinal(),
		...
		lbf.setEFormData(ILBFunctionConst.lbf_SubmissionLessAttachments[0][0]);

		lbf.setEFormData(ILBFunctionConst.lbf_StandardAwardLessElists[0][0]);

		lbf.setEProjType(EProjectType.post_Award);

		lbf.setEFormData(ILBFunctionConst.lbf_IPASLessAttachments[0][0]);

		lbf.setEFormData(ILBFunctionConst.lbf_POSubmissionLessELists[0][0]);
	...
	public void d_submitAndOpenStandardAgreementForm() throws Exception {
		...
		lbf.openAwardForm(ILBFunctionConst.lbf_StandardAwardLessElists[0][0]);
	}
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods = "g_testRowsEntriesOnIPASEFormNG")
	public void completeIPASAndSubmit() throws Exception {

		lbf.submitForm();

		ProjectUtil.openSubmissionInMyAssignedSubmissionList(lbf.proj,
				possStepName, "Open Projects");

	}

	@Test(groups = { "EFormsNG" }, dependsOnMethods = "completeIPASAndSubmit", dataProvider = "formletTypes")
	public void testRowsEntriesOnPOSSEFormNG(
			ILBFunctionConst.EFormletTypes eTypes) throws Exception {
	...
	public Object[][] generateFormletTypes(Method method) {
		...
		if (method.getName() == "b_testRowsEntriesOnSubmissionEFormNG"
				|| method.getName() == "g_testRowsEntriesOnIPASEFormNG") {

			result = new Object[][] { new Object[] { ILBFunctionConst.EFormletTypes.attchments } };

		} else if (method.getName() == "e_testRowsEntriesOnStandardEFormNG"
				|| method.getName() == "testRowsEntriesOnPOSSEFormNG") {
