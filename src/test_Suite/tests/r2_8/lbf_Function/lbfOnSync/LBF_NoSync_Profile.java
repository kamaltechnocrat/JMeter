...
public class LBF_NoSync_Profile {
	...
	public void submitAndOpenStandardAgreementForm() throws Exception {
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods = "submitAndOpenStandardAgreementForm", dataProvider = "formletTypes")
