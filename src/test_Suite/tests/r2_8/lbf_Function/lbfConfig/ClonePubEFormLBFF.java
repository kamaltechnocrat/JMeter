...
public class ClonePubEFormLBFF {
	...
	public void setUp() throws Exception {
		...
		Assert.assertTrue(subForm.publishForm(formlet.getFormletId()), "FAIL: could not publish eForm");
	...
	public void testCloningPublishedEFormNG() throws Exception {
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods = "testCloningPublishedEFormNG")
