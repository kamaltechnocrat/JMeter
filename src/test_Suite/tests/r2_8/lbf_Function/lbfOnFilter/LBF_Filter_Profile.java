...
public class LBF_Filter_Profile {
	...
	public void submitAndOpenAwardEFormNG() throws Exception {
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods = "submitAndOpenAwardEFormNG", dataProvider = "formletTypes")
	...
	@Test(groups = { "EFormsNG" }, dependsOnMethods="verifyFieldsAnswersOnAwardEFormNG")
