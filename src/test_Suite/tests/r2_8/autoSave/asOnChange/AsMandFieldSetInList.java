...
public class AsMandFieldSetInList {
	...
	String stepIdent = "A-AutoSave-Submission-Validation-eLists-Field";
	
	String stepName = "A AutoSave Submission Validation eLists Field";
	...
	public void settingTheTest() throws Exception {
		try {
			...
			auto.initializeProjAndCreateOrg("-eLists-Field", true, true);	
	...
	public void testAutoSave_WhenMandatoryFields_Set_OnDropdownChangedNG(EFormletType eFrmltName) throws Exception {
		
		auto.selectFromDropdown(eSelectable.inivisible, eFrmltName, true, true);
		
		Assert.assertFalse(auto.doesFieldVisible(), "FAIL: Field should be Invisible");
	}
	
	@Test(groups = { "EFormsNG" }, dependsOnMethods="settingTheTest")
	public void testAutoSave_WhenMandatoryFields_Set_OnCheckboxChangedNG() throws Exception {
		
		auto.selectCheckbox(true, EFormletType.checkboxVisible, true, true);
		
		Assert.assertFalse(auto.doesFieldVisible(), "FAIL: Field should be Invisible");
	}
	
	@Test(groups = { "EFormsNG" }, dependsOnMethods="settingTheTest")
	public void testAutoSave_WhenMandatoryFields_Set_OnRadioButtonChangedNG() throws Exception {
		
		auto.selectRadioButton(eSelectable.inivisible, true, true);
