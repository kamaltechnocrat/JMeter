...
public class AsChFieldStatInList {
	...
	String stepIdent = "A-AutoSave-Submission-Changing-eLists-Fields-Status";
	
	String stepName = "A AutoSave Submission Changing eLists Fields Status";
	...
	public void settingTheTest() throws Exception {
		try {
			...
			auto.initializeProjAndCreateOrg("-Changing-eLists-Fields-Status", true, true);	
	...
	public void testFieldVisibility_OnDropdownChangedNG(EFormletType eFrmltName) throws Exception {
		...
		auto.selectFromDropdown(eSelectable.inivisible, eFrmltName, true, false);
	...
	public void testFieldVisibility_OnCheckboxChangedNG() throws Exception {
		...
		auto.selectCheckbox(true, EFormletType.checkboxVisible, true, false);
	...
	public void testFieldVisibility_OnRadioButtonChangedNG() throws Exception {
		...
		auto.selectRadioButton(eSelectable.inivisible, true, false);
	...
	public void testFieldReadability_OnDropdownChangedNG(EFormletType eFrmltName) throws Exception {
		...
		auto.selectFromDropdown(eSelectable.readOnly, eFrmltName, true, false);
		
		Assert.assertTrue(auto.doesFieldReadOnly(), "FAIL: Field should be Read Only");
	}
	
	@Test(groups = { "EFormsNG" }, dependsOnMethods="settingTheTest")
	public void testFieldReadability_OnCheckboxChangedNG() throws Exception {
		
		auto.selectCheckbox(true, EFormletType.checkboxRead, true, false);
	...
	public void testFieldReadability_OnRadioButtonChangedNG() throws Exception {
		...
		auto.selectRadioButton(eSelectable.readOnly, true, false);
