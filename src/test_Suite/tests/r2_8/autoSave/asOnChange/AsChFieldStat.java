...
public class AsChFieldStat {
	...
	String stepIdent = "A-AutoSave-Submission-Changing-Field-Status";
	
	String stepName = "A AutoSave Submission Changing Field Status";
	...
	public void settingTheTest() throws Exception {
		try {
			...
			auto.initializeProjAndCreateOrg("-Changing-Field-Status", true, true);	
