...
public class AsChFormletStat {
	...
	String stepIdent = "A-AutoSave-Submission-Changing-Formlet-Status";
	
	String stepName = "A AutoSave Submission Changing Formlet Status";
	...
	public void settingTheTest() throws Exception {
		try {
			...
			auto.initializeProjAndCreateOrg("-Changing-Formlet-Status", true, true);	
	...
	public void testFieldVisibility_OnDropdownChangedNG(EFormletType eFrmltName) throws Exception {
		...
		Assert.assertFalse(auto.isFormletVisible(eFrmltName), "FAIL: Field should be Invisible");
	}
	...
	public void testFieldVisibility_OnCheckboxChangedNG() throws Exception {
		...
		Assert.assertFalse(auto.isFormletVisible(EFormletType.checkboxVisible), "FAIL: Field should be Invisible");
	}
	...
	public void testFieldVisibility_OnRadioButtonChangedNG() throws Exception {
		...
		Assert.assertFalse(auto.isFormletVisible(EFormletType.radio), "FAIL: Field should be Invisible");
	}
	...
	public void testFieldReadability_OnDropdownChangedNG(EFormletType eFrmltName) throws Exception {
		...
		Assert.assertTrue(auto.isFieldReadOnlyInFormlet(eFrmltName), "FAIL: Field should be Read Only");
	}
	...
	public void testFieldReadability_OnCheckboxChangedNG() throws Exception {
		...
		Assert.assertTrue(auto.isFieldReadOnlyInFormlet(EFormletType.checkboxRead), "FAIL: Field should be Read Only");
	}
	...
	public void testFieldReadability_OnRadioButtonChangedNG() throws Exception {
		...
		Assert.assertTrue(auto.isFieldReadOnlyInFormlet(EFormletType.radio), "FAIL: Field should be Read Only");
	}
