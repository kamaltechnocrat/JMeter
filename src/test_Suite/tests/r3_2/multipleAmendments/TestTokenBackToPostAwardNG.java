...
public class TestTokenBackToPostAwardNG {
	...
	public void setUp() {
		...
		try {
			...
			foProj = new FOProject(fopp, fopp.getFoppPreFix(), true, 3, "-CFG-TokenBackTo-PA-Step");
	 ...
	 */
	@Test(groups = { "WorkflowNG" }, dependsOnMethods = "requestSecondStepAmendment")
	public void verifyTokenBackToPostPaStep() throws Exception {
		try {
