...
public class Test_OrganizationEformData {
	// #####***********************************************************************
	...
	String postFix = "-Organization";

	String submissionStep = "Submission-A";

	String applicantName = "Ouia 1";

	String postAwardFormName = "A-Fetch-Post-Award-Submission-Organization";

	String postSubmissionStep = "Initial-Claim";

	String orgEFormName = "A-Data-Organization-eForm";
	...
	@Test(groups = { "FetchNonWorkFlowData" }, dataProvider = "Applicants-Data", dependsOnMethods = "selectAndOpenOrgForm", enabled = true)
	public void setOrgEfromData(String fieldId, String fieldValues)
			throws Exception {
		try {
	...
	public void selectAndOpenOrgForm() throws Exception {
		try {

			Assert.assertTrue(OrgUtil.selectAndOpenOrgEForm(orgName,
					orgEFormName));
	...
	@Test(groups = { "FetchNonWorkFlowData" }, dependsOnMethods = "setOrgEfromData", enabled = true)
	...
	public void validateApplicantSubmissionData() throws Exception {
		try {
			...
			Assert.assertTrue(EFormsUtil.validateOrgFieldValue(),
	...
	public static Object[][] generateAppProfileData() throws Exception {
		...
		{
				new Object[] { IeFormFieldsConst.organizationFormField_IDs[0],
						IeFormFieldsConst.organizationFormField_Value[0] },
				new Object[] { IeFormFieldsConst.organizationFormField_IDs[1],
						IeFormFieldsConst.organizationFormField_Value[1] },
				new Object[] { IeFormFieldsConst.organizationFormField_IDs[2],
						IeFormFieldsConst.organizationFormField_Value[2] }
