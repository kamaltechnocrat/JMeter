...
public class ETL_SettingApplicantProfile_EFormsFields {
	...
	public void setUp() {
		...
		try {
			...
			etl = EtlUtil.initializeNonProjectForm(IEtlConst.EetlEFormTypes.profile, EetlFormlets.minMax, EetlRptFldTypes.APPLICANT);
	...
	public void testAddingReportingFields() throws Exception {
		try {
			...
			Assert.assertTrue(EtlUtil.addingApplicantReportingFieldsFromEFormfield(etl), "FAIL: Could not add fields");
