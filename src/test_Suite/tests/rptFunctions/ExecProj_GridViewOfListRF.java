...
public class ExecProj_GridViewOfListRF {

	private static Log log = LogFactory.getLog(ExecProj_GridViewOfListRF.class);
	...
	String eFormIdent = IRptFuncConst.reportFunc_eFormsIdent[EeFormsIdentifier.awardGrid.ordinal()];
	...
	public void executeProject_BudgetGrid_ReportingFunctionNG()
			throws Exception {
	...
	public void setBudgetFormlet() throws Exception {

		RptFuncUtil.oneFormletHT = new LinkedHashMap<String, IRptFuncConst.EfieldDataTypes>();
		RptFuncUtil.oneFormletHT.put("Budget Formlet",
				IRptFuncConst.EfieldDataTypes.formlet);
		RptFuncUtil.oneFormletHT.put("My Budget Grid",
