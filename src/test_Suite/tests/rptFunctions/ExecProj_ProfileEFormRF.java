...
public class ExecProj_ProfileEFormRF {

	private static Log log = LogFactory
			.getLog(ExecProj_ProfileEFormRF.class);
	...
	String eFormIdent = IRptFuncConst.reportFunc_eFormsIdent[EeFormsIdentifier.profile
			.ordinal()];
	...
	public void executeProject_EList_ReportingFunctionNG() throws Exception {
	...
	@Test(groups = { "ReportingFunctionsNG" })
	public void executeProject_EListDataGrid_ReportingFunctionNG()
			throws Exception {

		try {

			setEListDataGridFormlet();
	...
	public void setEListFormlet() throws Exception {

		RptFuncUtil.oneFormletHT = new LinkedHashMap<String, IRptFuncConst.EfieldDataTypes>();
		RptFuncUtil.oneFormletHT.put("eList",
				IRptFuncConst.EfieldDataTypes.formlet);
		RptFuncUtil.oneFormletHT.put("FName",
				IRptFuncConst.EfieldDataTypes.stringTP);
		RptFuncUtil.oneFormletHT.put("LName",
				IRptFuncConst.EfieldDataTypes.stringTP);
		RptFuncUtil.oneFormletHT.put("Street Num",
				IRptFuncConst.EfieldDataTypes.numericTP);
		RptFuncUtil.oneFormletHT.put("Street Name",
				IRptFuncConst.EfieldDataTypes.stringTP);
		RptFuncUtil.oneFormletHT.put("PNumber",
				IRptFuncConst.EfieldDataTypes.stringTP);
		RptFuncUtil.oneFormletHT.put("PCode",
				IRptFuncConst.EfieldDataTypes.stringTP);
		RptFuncUtil.oneFormletHT.put("Province",
				IRptFuncConst.EfieldDataTypes.numericTP);
		RptFuncUtil.oneFormletHT.put("countries",
				IRptFuncConst.EfieldDataTypes.numericTP);
		RptFuncUtil.oneFormletHT.put("contactInfo",
				IRptFuncConst.EfieldDataTypes.stringTP);
	}

	public void setEListDataGridFormlet() throws Exception {
