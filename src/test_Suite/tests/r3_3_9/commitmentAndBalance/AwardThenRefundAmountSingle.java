...
public class AwardThenRefundAmountSingle {
	...
	public void cancelPayment() throws Exception {
		try {
			...
			Assert.assertTrue(GeneralUtil.selectFullStringInDropdownListByTitle("Cancel Or Not?", "No"), "FAIL: to Cancel Payment");
			
			Assert.assertTrue(GeneralUtil.setTextByTitle("Enter Cancelled Amount", "0.0"));
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="cancelPayment")
	public void RefundPayment() throws Exception {
		try {
			
			ProjectUtil.openEvaluateSubmissionFormletInList_New(foProj, "Refund-Review-CRQA", "Ready", "Cancel", false, "", "");
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="RefundPayment", dataProvider="Amounts-Data")
	...
	public static Object[][] generateRegLoginData() throws Exception{
		...
		return new Object[][] {
				...
				{IFoppConst.commBal_Budget_Refund_Ttl, 2000000.0},
