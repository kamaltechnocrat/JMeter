...
public class AwardedThenRefundedAmountBulk {
	...
	@Test(groups = { "ProjectsNG" }, dependsOnMethods="openRescindedBulkEval")
	public void openRefundedBulkEval() throws Exception {
		try {
			
			Assert.assertTrue(ProjectUtil.openBulkEvalStepsForEditing(foProj, "Refunded-Review-CRQA"), "FAIL: could not oepn Bulk");
